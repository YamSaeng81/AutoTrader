> ## ⚠️ 보관 문서 — 현재 동작의 근거로 쓰지 말 것
>
> **작성 시점: 2026-03-24** · 초기 개발 파이프라인의 검증 결과 보고서
> **2026-09-15 에 `docs/` 에서 `docs/archive/` 로 옮겼습니다.**
>
> 이 문서의 수치·구조 설명·"이게 문제다"라는 지적은 **작성 시점의 것**입니다. 이후 코드와
> 설정이 여러 차례 바뀌었고, 여기 적힌 문제 중 상당수는 이미 해소됐습니다.
> 현재 상태가 필요하면 아래를 보십시오.
>
> | 알고 싶은 것 | 볼 곳 |
> |---|---|
> | 저장소 구조 | [`PROJECT_STRUCTURE_ANALYSIS.md`](../../PROJECT_STRUCTURE_ANALYSIS.md) |
> | 현재 운영 상태 | [`docs/PROGRESS.md`](../PROGRESS.md) · [`docs/NEXT.md`](../NEXT.md) |
> | 무엇이 언제 바뀌었나 | [`docs/CHANGELOG.md`](../CHANGELOG.md) |
> | 지금 코드가 어떤지 | **코드 자체** — 문서보다 코드와 테스트가 우선입니다 |
>
> 보관 목록과 분류 기준: [`docs/archive/README.md`](README.md)
