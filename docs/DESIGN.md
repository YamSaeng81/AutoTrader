> ## 📌 이 문서의 현재 지위
>
> **버전 1.4 / 작성 2026-03-05 — 초기 아키텍처와 설계 의도를 담은 문서입니다.**
> 이후 6개월간 구조가 상당히 변했습니다(모듈 구성, 세션 종류, 스키마 분리, 4엔진 정합성 제약 등).
> **설계 의도를 이해하는 용도로 읽고, 현재 구조의 근거로는 쓰지 마십시오.**
>
> 현재 저장소 구조는 [`PROJECT_STRUCTURE_ANALYSIS.md`](../PROJECT_STRUCTURE_ANALYSIS.md) 에
