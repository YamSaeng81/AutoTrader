...
- [ ] **BLACK_SWAN_GUARD 오탐 수정 배포 + 잔여 확인** — 07-08 오탐 2건(세션 186/187 조기 손절, 거래량 5배 단독 발동 → SL 0.3% 조임)의 수정 완료: 거래량 조건 AND화(-2% 하락 동반 필수) + SL 강화 폭 ATR[1.2%, 5%] 클램프 + 텔레그램 알림. 상세 근거·정량 측정은 [`CHANGELOG.md`](CHANGELOG.md) 2026-07-08 항목. **미커밋 / 운영 미배포.**
