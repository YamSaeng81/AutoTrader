...
> **마지막 갱신**: 2026-07-15 (운영 DB 분석 — 동적 32~37 매수 0건 근본 원인 확정, 실전 188~193 현황)
...
- [x] **필터 스택 구조 결정 — 거래 빈도 확보로 2차 완화 (2026-07-15, 사용자 결정: 관망 대신 빈도↑)** — SCANNING 진입 경로 한정, 청산 경로 불변. **미커밋 / 운영 미배포.**
